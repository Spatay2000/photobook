...
class AddAlbumModel extends BaseNetworkModel<AddAlbumModel> {
  Data? data;
  String? status;

  AddAlbumModel({this.data, this.status});

  AddAlbumModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  AddAlbumModel fromJson(Map<String, dynamic> json) {
    return AddAlbumModel.fromJson(json);
  }
}
