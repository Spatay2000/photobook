...
class AddByWriterModel extends BaseNetworkModel<AddByWriterModel> {
  Data? data;
  String? status;

  AddByWriterModel({this.data, this.status});

  AddByWriterModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  AddByWriterModel fromJson(Map<String, dynamic> json) {
    return AddByWriterModel.fromJson(json);
  }
}
