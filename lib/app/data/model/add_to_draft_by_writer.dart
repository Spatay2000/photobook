...
class AddToDraftByWriterModel extends BaseNetworkModel<AddToDraftByWriterModel> {
  Data? data;
  String? status;

  AddToDraftByWriterModel({this.data, this.status});

  AddToDraftByWriterModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  AddToDraftByWriterModel fromJson(Map<String, dynamic> json) {
    return AddToDraftByWriterModel.fromJson(json);
  }
}
