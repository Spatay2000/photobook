...
class AddToDraftModel extends BaseNetworkModel<AddToDraftModel> {
  Data? data;
  String? status;

  AddToDraftModel({this.data, this.status});

  AddToDraftModel.fromJson(Map<String, dynamic> json) {
  ...
  @override
  AddToDraftModel fromJson(Map<String, dynamic> json) {
    return AddToDraftModel.fromJson(json);
  }
}
